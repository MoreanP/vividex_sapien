...
from algos.imitate.model.diffusion.conv1d_components import Downsample1d, Upsample1d, Conv1dBlock
from algos.imitate.model.diffusion.positional_embedding import SinusoidalPosEmb
...
class ConditionalUnet1D(nn.Module):
    def __init__(self, input_dim, local_cond_dim=None, global_cond_dim=None, diffusion_step_embed_dim=256, down_dims=[256,512,1024], kernel_size=3, n_groups=8, condition_type='film', use_down_condition=True, use_mid_condition=True, use_up_condition=True):
        super().__init__()
        self.condition_type = condition_type
