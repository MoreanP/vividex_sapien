...
from hand_imitation.utils.mesh_utils import compute_smooth_shading_normal_np
...
def render_body_to_open3d_mesh(render_body: sapien.RenderBody, use_texture=True) -> o3d.geometry.TriangleMesh:
    ...
    if body_type == "mesh":
        ...
        if body_type == "box":
            ...
            render_body_mesh = o3d.geometry.TriangleMesh(Vector3dVector(vertices), Vector3iVector(indices))
